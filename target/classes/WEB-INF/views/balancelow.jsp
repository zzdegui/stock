<%@page contentType="text/html" pageEncoding="UTF-8"
	extends="com.xmall.payment.web.BalanceLow"%>
...
<!--[if lt IE 9]>
<script src="//y.xgimg.net/js/vendor/html5.js?v=1.0.5"></script>
<![endif]-->
<!--[if IE 6]>
...
<script src="//y.xgimg.net/js/moui/1.0.5/mo.js?debug=true&mv=1.0.5&v=1.0.5"></script>
<script>
